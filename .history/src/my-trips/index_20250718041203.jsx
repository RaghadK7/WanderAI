    ...
    <div className='p-10 md:px-20 lg:px-36'>
      ...
      <div className="text-center mb-12">
        ...
        <p className="text-gray-600 text-lg font-medium">
          Discover your travel memories and plan your next adventure ✈️
        </p>
        <div className="mt-4 w-24 h-1 bg-gradient-to-r from-sky-300 to-cyan-300 rounded-full mx-auto"></div>
      </div>
