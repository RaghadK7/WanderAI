...
import { GetPlaceDetails } from '@/service/GlobalApi'; // Make sure the path is correct

// Add the missing PHOTO_REF_URL
const PHOTO_REF_URL =
...
function PlaceCardItem({ place }) {
  ...
  const GetPlacePhoto = async () => {
    ...
    try {
      ...
      if (photos?.length > 0) {
        // Use first image instead of fourth (photos[0] instead of photos[3])
