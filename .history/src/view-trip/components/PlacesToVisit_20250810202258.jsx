...
function PlacesToVisit({ trip }) {
  ...
  // البيانات جاية من Firebase كـ object، والـ itinerary جواه dailyPlans
  let itineraryArray = [];
  
  // إذا كان itinerary فيه dailyPlans
  ...
  // إذا كان itinerary هو array مباشرة
  ...
  return (
    <div className='mt-5'>
      {/* عنوان مطابق لستايل Hotels Recommendation */}
      <div className="flex items-center gap-3 mb-6">
        <div className="w-12 h-12 bg-gradient-to-r from-blue-500 to-cyan-500 rounded-full flex items-center justify-center shadow-lg">
          <span className="text-white text-xl">📍</span>
        </div>
              ...
              {item.plan && Array.isArray(item.plan) ? (
                item.plan.map((place, placeIndex) => (
                  ...
                  >
                    ...
                    {/* Place Card - Takes remaining space */}
