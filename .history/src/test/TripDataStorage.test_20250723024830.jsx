...
describe('Trip Data Storage Tests', () => {
  ...
  test('should save basic trip data successfully', async () => {
    ...
    global.localStorage.setItem(tripKey, JSON.stringify(mockTripData));
    
    expect(setDoc).toHaveBeenCalledWith(null, mockTripData);
    expect(global.localStorage.setItem).toHaveBeenCalledWith(tripKey, JSON.stringify(mockTripData));
  ...
  test('should simulate CreateTrip component workflow', async () => {
    ...
    global.localStorage.setItem(`AITrip_${docId}`, JSON.stringify(tripDocument));
    
    expect(setDoc).toHaveBeenCalledWith(null, tripDocument);
    expect(global.localStorage.setItem).toHaveBeenCalledWith(`AITrip_${docId}`, JSON.stringify(tripDocument));
