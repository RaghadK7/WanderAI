...
// Fixed imports - استخدم هذه المسارات:
...
function Header() {
   ...
   * Supports both login and registration with better error handling
   */
  const handleEmailAuth = async () => {
    ...
    try {
      ...
      if (isLogin) {
        ...
        console.log('Account created successfully for:', authData.email)
