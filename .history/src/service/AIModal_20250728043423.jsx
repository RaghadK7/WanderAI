...
// برومبت محسن مع مسافات حقيقية و 4 أنشطة
const createTravelPrompt = (location, days, traveler, budget) => {
  ...
  for (let i = 1; i <= parseInt(days); i++) {
    itineraryTemplate.push(`{
      "day": "Day ${i}",
      "plan": [
        {"time": "09:00-11:00", "placeName": "Morning Activity", "placeDetails": "Details", "placeImageUrl": "URL", "geoCoordinates": "lat,lng", "ticketPricing": "Price", "timeToTravel": "Calculate real distance"},
        {"time": "11:30-13:00", "placeName": "Late Morning Activity", "placeDetails": "Details", "placeImageUrl": "URL", "geoCoordinates": "lat,lng", "ticketPricing": "Price", "timeToTravel": "Calculate real distance"},
        {"time": "14:00-16:00", "placeName": "Afternoon Activity", "placeDetails": "Details", "placeImageUrl": "URL", "geoCoordinates": "lat,lng", "ticketPricing": "Price", "timeToTravel": "Calculate real distance"},
        {"time": "17:00-19:00", "placeName": "Evening Activity", "placeDetails": "Details", "placeImageUrl": "URL", "geoCoordinates": "lat,lng", "ticketPricing": "Price", "timeToTravel": "Calculate real distance"}
      ]
    }`);
  }
...
- Calculate ACTUAL travel time between locations (5min for nearby, 15min for same area, 30min+ for different areas)
- For timeToTravel: put real driving/walking time like "5min", "15min", "25min", "45min"
- Each day has exactly 4 activities with realistic timing
