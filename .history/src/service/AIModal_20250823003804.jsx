...
export const generateTravelPlan = async (location, days, traveler, budget) => {
  try {
    ...
    const parsed = await tryModels(prompt);
    ...
    // تأكد من أن itinerary مصفوفة
    parsed.itinerary = Array.isArray(parsed.itinerary) ? parsed.itinerary : Object.values(parsed.itinerary || []);
    return parsed;
